...
import {useReturnTripState} from "../../hooks/useReturnTripState";
...
const TransferSummaryCard = memo(function (props) {
  ...
  function confirmReturn(e) {
    ...
    if (returnDate && returnHour && personCount) {
      ...
      localStorage.setItem("returnHour", returnHour);
      localStorage.setItem("returnPassengerCount", personCount);
        ...
        <figure className="flex flex-col gap-2">
          ...
          <div>
            ...
            <div className="p-2 flex flex-col gap-1">
              <h3 className="font-bold">{props.from_destination}</h3>
              <p className="text-xs">{props.from_city}</p>
              <h3 className="font-bold">{props.to_destination}</h3>
              <p className="text-xs">{props.to_city}</p>
            </div>
            <div className="flex items-center gap-2">
              ...
              <p className="text-xs">{props.departure_date}</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
              ...
              <p className="text-xs">{props.departure_hour}</p>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <p className="text-xs">{`${props.outward_count} people`}</p>
            ...
            <p className="text-xs">{`${props.total_distance} km`}</p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={24}
              height={24}
            ...
            <p className="text-xs">{props.total_hour}</p>
          </div>
          <hr className=" text-gray w-full"></hr>
            ...
            <div id="return">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <p className="text-xs">{`${props.return_count} people`}</p>
                  {/* Destination Icon iconify */}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
