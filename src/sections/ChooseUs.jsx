...
const cardInfo = [
  ...
  },
  {
    ...
    svg: (
<svg xmlns="http://www.w3.org/2000/svg" className="w-fit h-16 lg:h-20" viewBox="0 0 26 26">
	<g fill="oklch(59.27% 0.2264 26.75)" fillRule="evenodd" clipRule="evenodd">
