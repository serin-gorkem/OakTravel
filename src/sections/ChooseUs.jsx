...
const ChooseUs = memo(function () {
  ...
  return (
    <section className="h-fit mt-16 px-2 pb-8 flex flex-col lg:p-0 lg:max-w-10/12 mx-auto flex-wrap gap-4">
      <div className="flex flex-col gap-2.5">
        <h2 className="text-warning text-xl font-bold font-heading leading-tight">
          Why Choose Us
        </h2>
        <h3 className=" text-2xl font-medium">Service Tailored to You</h3>
      </div>
...
const cardInfo = [
  ...
  },
  {
    ...
    svg: (
<svg xmlns="http://www.w3.org/2000/svg" className="w-fit h-16" viewBox="0 0 26 26">
