      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <form className="flex flex-col gap-2 lg:w-1/2">
          <fieldset className="fieldset flex focus-within:outline-0">
            <legend className="font-bold text-sm lg:text-base">First Name <span className="text-warning">*</span></legend>
            <input
              type="text"
              id="name"
          ...
          <fieldset className="fieldset flex focus-within:outline-0">
            <legend className="font-bold text-sm lg:text-base">Last Name <span className="text-warning">*</span></legend>
            <input
              type="text"
              id="name"
          ...
          <fieldset className="fieldset flex focus-within:outline-0">
            <legend className="font-bold text-sm lg:text-base">Email <span className="text-warning">*</span></legend>
            <input
              type="text"
              id="name"
              autoComplete="email"
          ...
          <fieldset className="fieldset flex focus-within:outline-0">
            <legend className="font-bold text-sm lg:text-base">Phone Number</legend>
            <input
              type="text"
              id="name"
              autoComplete="tel"
        ...
        <div className="flex flex-col gap-2 lg:w-1/2">
          ...
          <div className="flex  items-center justify-between text-xs">
            <p className="w-1/2 lg:text-base">Call our team Mon-Fri From 8am to 5pm</p>
            <div className="flex gap-2 ">
              ...
              <a className=" text-xs lg:text-base">0090 256 999 16 19</a>
            </div>
          </div>
          <h2 className="text-xl lg:text-2xl font-bold">Join Us</h2>
          <p className="text-xs lg:text-base">Our office is located in Turkey / Kusadasi</p>
          <iframe
            loading="lazy"
            allowfullscreen
