...
const Home = memo(function () {
  return (
    <section id="home" className="lg:h-screen mb-24 md:mb-40 lg:mb-16 border-red-500 flex flex-col relative sm:gap-5">
      <Nav />
      <img
        src={backgroundImage}
      ...
      >
        <div className="flex flex-col w-fit xl:h-96 gap-4">
          <h1 className="font-heading font-bold tracking-tight leading-snug text-2xl sm:w-full lg:leading-tight lg:w-fit xl:w-9/12 sm:text-4xl xl:text-6xl text-base-100">
            Reliable <span className=" text-warning ">Airport Transport. </span>
            Comfort & Punctuality with Oak Travel.
          </h1>
          <h2 className="font-paragraph xl:pb-8 text-xs font-light text-white opacity-80 sm:w-full md:w-5/7 sm:text-sm xl:text-base xl:w-8/12 w-fit leading-relaxed tracking-tighter">
