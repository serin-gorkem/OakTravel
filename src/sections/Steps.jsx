  ...
  return (
    <section id="steps" className="h-fit mt-16 px-2 pb-8 flex flex-col lg:p-0 lg:max-w-9/12 mx-auto gap-8 lg:gap-16">
      ...
      <article className="flex flex-col gap-8 lg:gap-24">
        ...
        <Step svg={step_2} title="Step 2: Choose Your Vehicle" text="Browse our 🚖 luxury, 💼 business, and 💲 economy airport transfer vehicles. Each option includes detailed features, ✅ transparent pricing, and unmatched comfort to fit your needs." direction="-reverse" />
        ...
        <Step svg={step_4} title="Step 4: Secure & Instant Confirmation" text="Enter your 🔐 personal details, confirm your ✅ booking, and receive 📩 instant confirmation. With 🕒 24/7 Owl Travel support, your airport transfer is always reliable and hassle-free." direction="-reverse" />
      </article>
    </section>
  );
});
...
function Step(props) {
  return (
    <div className={`flex flex-col w-full lg:flex-row${props.direction} justify-between gap-8 xl:gap-32`}>
